...
export const DropMenu = () => {
  ...
  return (
    <div className="gap-2 relative group">
      <SiOpsgenie size={30} color={resolvedTheme==='light'?"black":'white'}/>
      <div className="z-50 transition-all h-0 overflow-hidden min-w-max delay-300 duration-700 ease-in-out absolute top-8 right-0 group-hover:h-40">
